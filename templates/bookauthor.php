...
<div align="center">
<div id="k">
            <hr color="blue"><h1>BOOK AUTHORS INFORMATION</h1>
                <hr color="blue">
</div><br>
 <form action="bookauthor.php" method="post" >
  <b>BOOK ID:</b>
  <input type="text" placeholder="Enter User ID" name="Book_id"><br><br>
  <b>Author Name:</b>
  <input type="text" placeholder="Enter Name" name="Author_Name"><br><br>
  <button id="btn1">INSERT</button>     
                </form><br>
                <a href="displaybookauthors.php">
                    <button id="btn1">DISPLAY</button>
                 </a>
                 <a href="deletebookauthors.php">
...
if (isset($_POST['Author_Name']))
{
    ...
    $s="INSERT INTO `venky`.`BOOK_AUTHORS`(`Book_id`,`Author_Name`) VALUES('$Book_id', '$Author_Name')";
     if ($c->query($s)==true) {
