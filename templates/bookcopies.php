...
<div align="center">
<div id="k">
            <hr color="blue"><h1>BOOK COPIES INFORMATION</h1>
                <hr color="blue">
</div><br>
 <form action="bookcopies.php" method="post" >
  <b>BOOK ID:</b>
  <input type="text" placeholder="Enter User ID" name="Book_id"><br><br>
  <b>Branch id:</b>
  <input type="text" placeholder="Enter Name" name="Branch_id"><br><br>
  <b>No of Copies:</b>
  <input type="text" placeholder="Enter Publisher_Name" name="No_of_Copies"><br><br>
  <button id="btn1">INSERT</button> 
                </form><br>
                <a href="displaybookcopies.php">
                    <button id="btn1">DISPLAY</button>
                 </a>
                 <a href="deletebookcopies.php">
...
if (isset($_POST['No_of_Copies']))
{
    ...
    $s="INSERT INTO `venky`.`Book_copies`(`Book_id`,`Branch_id`,`No_of_Copies`) VALUES('$Book_id', '$Branch_id', '$No_of_Copies')";
     if ($c->query($s)==true) {
